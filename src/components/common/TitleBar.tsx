...
import { Minus, Square, X, Settings, LogOut, ChevronDown, User } from 'lucide-react';
            ...
            >
                ...
                {isAuthenticated && user ? (
                    <div className="relative h-full" ref={dropdownRef}>
                        ...
                        {/* Dropdown Menu */}
                        {dropdownOpen && (
                            <div className="absolute right-0 top-full mt-1 w-48 bg-[#1b2838] border border-chanox-border rounded-md shadow-lg z-50 overflow-hidden">
                                {/* User Info */}
