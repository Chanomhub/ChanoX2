            ...
            <div className="w-full max-w-md p-8 bg-card rounded-lg border border-border">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full py-2 bg-chanox-accent text-chanox-surface font-bold rounded-md hover:bg-chanox-accent/90 transition-colors disabled:opacity-50"
                    >
                ...
                <div className="mt-6">
                    ...
                    <button
                        ...
                        className="mt-4 w-full py-2 bg-white text-black font-medium rounded-md hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
                    >
